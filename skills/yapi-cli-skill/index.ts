...
import { generateMockData, generateTypes, getInterfaceDetails, searchInterfaces } from '../../cli/public-api'

const program = new Command()

program.name('yapi-skill').description('Skill-friendly YApi wrapper built on top of the CLI core').version('1.0.0')
